...
const PreLaunchProperties = () => {
    ...
    return (<div className="bg-[#f5f5f5] pb-16 flex flex-col gap-6 justify-evenly">
        <div className={` ${fastSellingGutter} py-6 md:py-8`}>
            <h3 className="text-3xl font-bold text-slate-950 sm:text-4xl lg:text-5xl">Pre-Launch Properties</h3>
            <p className="mt-2 whitespace-nowrap text-sm tracking-wide text-[#df472b] sm:text-base ">
                Exclusive early access to properties before they hit the market, ideal for proactive group buyers.
            </p>
            
        </div>

        <PropertyCarousel
            displaySection="PRE_LAUNCH"
...
export default PreLaunchProperties
